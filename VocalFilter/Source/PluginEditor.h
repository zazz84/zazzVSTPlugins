...
//==============================================================================
class VocalFilterAudioProcessorEditor : public juce::AudioProcessorEditor
{
public:
    VocalFilterAudioProcessorEditor (VocalFilterAudioProcessor&, juce::AudioProcessorValueTreeState&);
    ~VocalFilterAudioProcessorEditor() override;
...
protected:
    VocalFilterAudioProcessor& audioProcessor;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (VocalFilterAudioProcessorEditor)
};
