...
//==============================================================================
MSAudioProcessorEditor::MSAudioProcessorEditor (MSAudioProcessor& p, juce::AudioProcessorValueTreeState& vts)
...
{	
	...
	for (int i = 0; i < N_SLIDERS; i++)
	{
		...
		std::string text = MSAudioProcessor::paramsNames[i];
...
MSAudioProcessorEditor::~MSAudioProcessorEditor()
{
}

//==============================================================================
void MSAudioProcessorEditor::paint (juce::Graphics& g)
{
	g.fillAll(ZazzLookAndFeel::LIGHT_COLOUR);
}

void MSAudioProcessorEditor::resized()
{
