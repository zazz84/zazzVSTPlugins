...
//==============================================================================
class SmallRoomReverbAudioProcessorEditor : public juce::AudioProcessorEditor, public ZazzAudioProcessorEditor
{
public:
    SmallRoomReverbAudioProcessorEditor (SmallRoomReverbAudioProcessor&, juce::AudioProcessorValueTreeState&);
...
protected:
    SmallRoomReverbAudioProcessor& audioProcessor;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SmallRoomReverbAudioProcessorEditor)
};
