...
const int SmallRoomReverb51AudioProcessorEditor::SLIDERS[] = { 4, 4, 4, 1 };
const float SmallRoomReverb51AudioProcessorEditor::COLUMN_OFFSET[] = { 0.0f, 0.0f, 0.0f, 1.5f };

//==============================================================================
SmallRoomReverb51AudioProcessorEditor::SmallRoomReverb51AudioProcessorEditor (SmallRoomReverb51AudioProcessor& p, juce::AudioProcessorValueTreeState& vts)
    : AudioProcessorEditor (&p), audioProcessor (p), valueTreeState(vts)
{	
	// Plugin name
	m_pluginName.setText("SmallRoomReverb51", juce::dontSendNotification);
	...
	for (int i = 0; i < N_SLIDERS; i++)
	{
		...
		const std::string text = SmallRoomReverb51AudioProcessor::paramsNames[i];
		const std::string unit = SmallRoomReverb51AudioProcessor::paramsUnitNames[i];
...
SmallRoomReverb51AudioProcessorEditor::~SmallRoomReverb51AudioProcessorEditor()
{
}

//==============================================================================
void SmallRoomReverb51AudioProcessorEditor::paint (juce::Graphics& g)
{
	g.fillAll(ZazzLookAndFeel::BACKGROUND_COLOR);
}

void SmallRoomReverb51AudioProcessorEditor::resized()
{
