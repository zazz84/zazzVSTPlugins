...
//==============================================================================
class TransientEnhancerAudioProcessorEditor : public juce::AudioProcessorEditor
{
public:
    TransientEnhancerAudioProcessorEditor (TransientEnhancerAudioProcessor&, juce::AudioProcessorValueTreeState&);
    ~TransientEnhancerAudioProcessorEditor() override;
...
protected:
    TransientEnhancerAudioProcessor& audioProcessor;
	...
	ModernRotarySlider m_cooldownSlider;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TransientEnhancerAudioProcessorEditor)
};
