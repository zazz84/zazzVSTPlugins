...
//==============================================================================
class GuitarAmpAudioProcessorEditor : public juce::AudioProcessorEditor, public ZazzAudioProcessorEditor
{
public:
    GuitarAmpAudioProcessorEditor (GuitarAmpAudioProcessor&, juce::AudioProcessorValueTreeState&);
