...
const int ZeroCrossingGateAudioProcessorEditor::SLIDERS[] = { N_SLIDERS };
const float ZeroCrossingGateAudioProcessorEditor::COLUMN_OFFSET[] = { 0.0f };

//==============================================================================
ZeroCrossingGateAudioProcessorEditor::ZeroCrossingGateAudioProcessorEditor (ZeroCrossingGateAudioProcessor& p, juce::AudioProcessorValueTreeState& vts)
    : AudioProcessorEditor (&p), audioProcessor (p), valueTreeState(vts)
{	
	// Plugin name
	m_pluginName.setText("ZeroCrossingGate", juce::dontSendNotification);
	...
	for (int i = 0; i < N_SLIDERS; i++)
	{
		...
		const std::string text = ZeroCrossingGateAudioProcessor::paramsNames[i];
		const std::string unit = ZeroCrossingGateAudioProcessor::paramsUnitNames[i];
...
ZeroCrossingGateAudioProcessorEditor::~ZeroCrossingGateAudioProcessorEditor()
{
}

//==============================================================================
void ZeroCrossingGateAudioProcessorEditor::paint (juce::Graphics& g)
{
	g.fillAll(ZazzLookAndFeel::BACKGROUND_COLOR);
}

void ZeroCrossingGateAudioProcessorEditor::resized()
{
