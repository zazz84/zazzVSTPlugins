...
const int VelvetNoiseReverbAudioProcessorEditor::SLIDERS[] = { N_SLIDERS };
const float VelvetNoiseReverbAudioProcessorEditor::COLUMN_OFFSET[] = { 0.0f };

//==============================================================================
VelvetNoiseReverbAudioProcessorEditor::VelvetNoiseReverbAudioProcessorEditor (VelvetNoiseReverbAudioProcessor& p, juce::AudioProcessorValueTreeState& vts)
    : AudioProcessorEditor (&p), audioProcessor (p), valueTreeState(vts)
{	
	// Plugin name
	m_pluginName.setText("VelvetNoiseReverb", juce::dontSendNotification);
	...
	for (int i = 0; i < N_SLIDERS; i++)
	{
		...
		const std::string text = VelvetNoiseReverbAudioProcessor::paramsNames[i];
		const std::string unit = VelvetNoiseReverbAudioProcessor::paramsUnitNames[i];
...
VelvetNoiseReverbAudioProcessorEditor::~VelvetNoiseReverbAudioProcessorEditor()
{
}

//==============================================================================
void VelvetNoiseReverbAudioProcessorEditor::paint (juce::Graphics& g)
{
	g.fillAll(ZazzLookAndFeel::BACKGROUND_COLOR);
}

void VelvetNoiseReverbAudioProcessorEditor::resized()
{
