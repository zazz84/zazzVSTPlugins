...
const int SurroundTo3ToSurroundAudioProcessorEditor::SLIDERS[] = { N_SLIDERS };
const float SurroundTo3ToSurroundAudioProcessorEditor::COLUMN_OFFSET[] = { 0.0f };

//==============================================================================
SurroundTo3ToSurroundAudioProcessorEditor::SurroundTo3ToSurroundAudioProcessorEditor (SurroundTo3ToSurroundAudioProcessor& p, juce::AudioProcessorValueTreeState& vts)
    : AudioProcessorEditor (&p), audioProcessor (p), valueTreeState(vts)
{	
	// Plugin name
	m_pluginName.setText("SurroundTo3ToSurround", juce::dontSendNotification);
	...
	for (int i = 0; i < N_SLIDERS; i++)
	{
		...
		const std::string text = SurroundTo3ToSurroundAudioProcessor::paramsNames[i];
		const std::string unit = SurroundTo3ToSurroundAudioProcessor::paramsUnitNames[i];
...
SurroundTo3ToSurroundAudioProcessorEditor::~SurroundTo3ToSurroundAudioProcessorEditor()
{
}

//==============================================================================
void SurroundTo3ToSurroundAudioProcessorEditor::paint (juce::Graphics& g)
{
	g.fillAll(ZazzLookAndFeel::BACKGROUND_COLOR);
}

void SurroundTo3ToSurroundAudioProcessorEditor::resized()
{
