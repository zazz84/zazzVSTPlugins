...
//==============================================================================
class SurroundTo3ToSurroundAudioProcessorEditor : public juce::AudioProcessorEditor, public ZazzAudioProcessorEditor
{
public:
    SurroundTo3ToSurroundAudioProcessorEditor (SurroundTo3ToSurroundAudioProcessor&, juce::AudioProcessorValueTreeState&);
...
protected:
    SurroundTo3ToSurroundAudioProcessor& audioProcessor;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SurroundTo3ToSurroundAudioProcessorEditor)
};
