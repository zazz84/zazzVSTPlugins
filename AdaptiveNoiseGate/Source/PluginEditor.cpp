...
const int AdaptiveNoiseGateAudioProcessorEditor::SLIDERS[] = { N_SLIDERS };
const float AdaptiveNoiseGateAudioProcessorEditor::COLUMN_OFFSET[] = { 0.0f };

//==============================================================================
AdaptiveNoiseGateAudioProcessorEditor::AdaptiveNoiseGateAudioProcessorEditor (AdaptiveNoiseGateAudioProcessor& p, juce::AudioProcessorValueTreeState& vts)
    : AudioProcessorEditor (&p), audioProcessor (p), valueTreeState(vts)
{	
	// Plugin name
	m_pluginName.setText("AdaptiveNoiseGate", juce::dontSendNotification);
	...
	for (int i = 0; i < N_SLIDERS; i++)
	{
		...
		const std::string text = AdaptiveNoiseGateAudioProcessor::paramsNames[i];
		const std::string unit = AdaptiveNoiseGateAudioProcessor::paramsUnitNames[i];
