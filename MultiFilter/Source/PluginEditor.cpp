...
const int MultiFilterAudioProcessorEditor::SLIDERS[] = { N_SLIDERS };
const float MultiFilterAudioProcessorEditor::COLUMN_OFFSET[] = { 0.0f };

//==============================================================================
MultiFilterAudioProcessorEditor::MultiFilterAudioProcessorEditor (MultiFilterAudioProcessor& p, juce::AudioProcessorValueTreeState& vts)
    : AudioProcessorEditor (&p), audioProcessor (p), valueTreeState(vts)
{	
	// Plugin name
	m_pluginName.setText("MultiFilter", juce::dontSendNotification);
	...
	for (int i = 0; i < N_SLIDERS; i++)
	{
		...
		const std::string text = MultiFilterAudioProcessor::paramsNames[i];
		const std::string unit = MultiFilterAudioProcessor::paramsUnitNames[i];
...
//==============================================================================
void MultiFilterAudioProcessorEditor::paint (juce::Graphics& g)
{
