...
//==============================================================================
class MultiFilterAudioProcessorEditor : public juce::AudioProcessorEditor, public ZazzAudioProcessorEditor
{
public:
    MultiFilterAudioProcessorEditor (MultiFilterAudioProcessor&, juce::AudioProcessorValueTreeState&);
    ~MultiFilterAudioProcessorEditor() override;
...
protected:
    MultiFilterAudioProcessor& audioProcessor;
